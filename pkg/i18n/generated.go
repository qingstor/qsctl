...
func initEnUS(tag language.Tag) {
	...
	_ = message.SetString(tag, "Set config: qsctl configure", "Set config: qsctl configure")
	...
	_ = message.SetString(tag, "Try to load config failed [%v]\n", "Try to load config failed [%v]\n")
	...
	_ = message.SetString(tag, "configure interactively", "configure interactively")
	...
	_ = message.SetString(tag, "qsctl configure can invoke interactive (re)configuration tool", "qsctl configure can invoke interactive (re)configuration tool")
	...
	_ = message.SetString(tag, "qsctl not run interactively", "qsctl not run interactively")
